...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            ...
            <small>Empty Rooms (<?php echo $np;?>)</span></small></h1>
        </div>
       ...
       <!-- /.col-lg-4 -->
        ...
        <?php
        $sql1 = "SELECT * FROM rooms WHERE roomStatus = 'empty' LIMIT $page,7;";
        ...
        for ($b=1; $b <=$a ; $b++) { 
            ?>    
         <span class='label label-info'><a href = "empty.php?page=<?php echo $b;?>"style = "text-decoration:none;"><?php echo $b," "; ?></a></span>
        <?php
        }
        ?>        
        </td>
