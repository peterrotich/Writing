...
$sql2 = ("INSERT INTO `kmh`.`tbl_refund` (`id`, `refundType`, `names`, `IdNumber`, `phoneNumber`, `recieptCode`, `amount`, `accountNumber`, `securityCode`, `mpesaNumber`, `transactionCode`) 
        VALUES (NULL, 'MPesa Refund', '$names', '$idNumber', '$phoneNumber', '$recieptCode', '$amount', 'Null','Null', '$mpesaNumber', '$transactionCode')");
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            ...
            <small>Refund via MPesa</span></small></h1>
        </div>
         ...
         <div class="col-lg-8">
            ...
            <tr>
                <td>MPesa Number:</td>
                <td><input type = "text" name="mpesaNumber" id="mpesaNumber" maxlength="19" pattern = "[0-9]*" required></td>
                <td>Transaction Code:</td>
                <td><input type = "text" name="transactionCode" id="transactionCode" maxlength="10" pattern = "[A-Z0-9]*" required></td>
            </tr>                                      
            <tr>
                <td colspan="4" style="text-align:center">
                <button type="submit" name="refund" class="btn btn-primary">M-Pesa Refund</button>
                </td>
            </tr>
            </table>
                </div>
