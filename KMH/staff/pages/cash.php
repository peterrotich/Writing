...
$sql2 = ("INSERT INTO `kmh`.`tbl_refund` (`id`, `refundType`, `names`, `IdNumber`, `phoneNumber`, `recieptCode`, `amount`, `accountNumber`,`securityCode`, `mpesaNumber`,`transactionCode`) 
        VALUES (NULL, 'Cash', '$names', '$idNumber', '$phoneNumber', '$recieptCode', '$amount', 'Null','Null','Null', 'Null')");
        ...
        <div class="col-lg-12">
         ...
         <div class="col-lg-8">
            ...
            <tr>
                ...
                <button type="submit" name="refund" class="btn btn-success">Refund Cash</button>
                </td>
            </tr>
            </table>
                </div>
