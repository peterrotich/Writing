...
include("connect.php");
include("session.php");
$_SESSION["editT"]=$_GET["id"];
$id = $_SESSION["editT"];

$sql = "SELECT * FROM `roomtype` WHERE uniqueId = '$id'";
...
<div class="container-fluid">
    <div class="row">
        ...
        <tr>
        <th>Room Type: </th>
        <th><input type = "text" name="roomType" id="roomType" maxlength="10" value="<?php echo $roomType?>" style = "width:100%" pattern = "[A-Za-z]*"></th>
        </tr>

        <tr>
        <th>Price Per Day: </th>
        <th><input type = "text" name="pricePerday" id="pricePerday" maxlength="4" value="<?php echo $pricePerday?>" style = "width:100%" pattern = "[0-9]*" ></th>
        </tr>
