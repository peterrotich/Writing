...
if (!$query2) {
    ...
    echo "<script> if(confirm('Admin Has Been Successfully Added')==true){window.location='admin.php';} </script>";  
...
<div class="container-fluid">
    <div class="row">
        ...
        <td>
        <button type="submit" name="submit" class="btn btn-outline btn-success">Add Admin</button>
        </td>
        </tr>
        <tr>
            <td colspan="4">
