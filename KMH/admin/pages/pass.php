...
if (!$query2) {
    ...
    echo "<script> if(confirm('Password Successfully Changed')==true){window.location='users.php';} </script>";  
...
<div class="container-fluid">
    <div class="row">
        ...
        <tr>
            ...
            <small>Change User Password</span>    
            </small>
            </td>
        </tr>
        <th >Password</th>
        ...
        <td>
        <button type="submit" name="submit" class="btn btn-outline btn-success">Change User Password</button>
        </td>
        </tr>
        <tr>
            <td colspan="3">
