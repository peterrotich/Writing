...
$cr = "SELECT * FROM `tbl_users` WHERE status = 'deleted'";
$tl = mysql_query($cr);
...
<div class="container-fluid">
    <div class="row">
        ...
        <?php
        $sql = "SELECT * FROM `tbl_users` WHERE status = 'deleted' LIMIT $page,7;";
        ...
        <a href="restoreUser.php?id=<?=$row["uniqueId"];?>">
        <i class="fa fa-undo fa-fw" style="font-size:20px;" data-toggle="tooltip" data-placement="left" title="Restore User"></i></a>
        ...
        <?php
        $cou = "SELECT * FROM `tbl_users` WHERE status = 'deleted'";
