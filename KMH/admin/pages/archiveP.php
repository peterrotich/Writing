...
$cr = "SELECT * FROM `tbl_reserved` WHERE roomStatus = 'deleted'";
$tl = mysql_query($cr);
...
<div class="container-fluid">
    <div class="row">
        ...
        <?php
        $sql = "SELECT * FROM `tbl_reserved` WHERE roomStatus = 'deleted' LIMIT $page,7;";
        ...
        <a href="restoreArchiveP.php?id=<?=$row["id"];?>">
        ...
        <?php
        $cou = "SELECT * FROM `tbl_reserved` WHERE roomStatus = 'deleted'";
        ...
        for ($b=1; $b <=$a ; $b++) { 
            ?>    
         <span class='label label-info'><a href = "archiveP.php?page=<?php echo $b;?>"style = "text-decoration:none;"><?php echo $b," "; ?></a></span>
        <?php
        }
        ?>        
        </td>
