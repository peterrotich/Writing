...
<div class="container-fluid">
    <div class="row">
        ...
        <?php
        $sql = "SELECT * FROM `tbl_reservation_request` WHERE roomStatus = 'active' LIMIT $page,7;";
        ...
        if ($check<1) {
            echo "There are no booked rooms at the monent";
        }
        ?>
        </td>
        </tr>
        ...
        <?php
        $cou = "SELECT * FROM `tbl_reservation_request` WHERE roomStatus = 'active'";
        ...
        for ($b=1; $b <=$a ; $b++) { 
            ?>    
         <span class='label label-info'><a href = "booked.php?page=<?php echo $b;?>"style = "text-decoration:none;"><?php echo $b," "; ?></a></span>
        <?php
        }
        ?>        
        </td>
