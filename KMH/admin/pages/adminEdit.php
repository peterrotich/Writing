...
if (!$query2) {
    ...
    echo "<script> if(confirm('Admin Successfully Updated')==true){window.location='admin.php';} </script>";  
...
<div class="container-fluid">
    <div class="row">
        ...
        <td>
        <button type="submit" name="submit" class="btn btn-outline btn-success">Update Admin</button>
        </td>
        </tr>
        <tr>
            <td colspan="3">
